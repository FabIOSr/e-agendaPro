-- Migration 35: aumenta limite free de 10 para 30 agendamentos por mes
-- Altera a constante v_limite_free na funcao criar_agendamento_atomic
-- e recria a funcao com o novo valor.
...
IS 'Cria agendamento de forma atomica com lock por prestador, validacoes de limite (30/mes free), conflitos, bloqueios e reserva da lista de espera.';
